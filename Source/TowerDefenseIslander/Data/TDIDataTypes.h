...
// ============================================================
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_Gold)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_Wood)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_Leather)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_Bone)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_DarkEssence)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_Silk)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_Venom)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_Stone)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_Iron)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_DragonScale)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Resource_Crystal)

TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Research_Tier1Towers)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Research_Tier2Towers)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Research_Tier3Towers)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Research_Tier4Towers)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Research_FasterCarts)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Research_ExtraWorkers)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Research_StrongerWalls)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Research_CartCapacity)

TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Effect_Slow)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Effect_Burn)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Effect_Poison)
TOWERDEFENSEISLANDER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TDITag_Effect_Stun)
